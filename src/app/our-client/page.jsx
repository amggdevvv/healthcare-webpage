    ...
    <div className="my-8 h-full w-full">
      ...
      <div className="mx-auto mt-10 grid max-w-7xl grid-cols-1 gap-3 px-6 sm:grid-cols-2 lg:grid-cols-3">
        {cardContent.map((client, index) => (
          <div key={index} className="relative min-h-[350px]">
            <div className="inset-0 h-auto">
              <div className="flex h-36 w-full items-center justify-center rounded-t-2xl bg-gray-200">
                <Image
                  src={client.logo}
      ...
      {/* <div className="mx-auto mt-10 grid max-w-7xl grid-cols-1 gap-3 px-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="relative min-h-[350px]">
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 rounded-b-2xl bg-[radial-gradient(54.97%_272.54%_at_27.36%_-134.72%,_#66181f_0,_rgb(20_0_0)_100%)] p-6 text-white">
              <p>
                “I highly recommend Trial Template for all graphics and
                presentation projects. If you have a story to tell in trial,
                Trial Template has the tools to help you create narratives the
                jury can understand.”
              </p>
              <div className="mt-6 flex gap-6">
                <Image
